      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-16">
          ...
          <p className="text-[13.5px] text-white/50 leading-relaxed font-light font-sans max-w-2xl">
            Read the contractual agreements, acceptable use policies, and platform availability guarantees for NeoFace services.
          </p>
        </div>
        ...
        <motion.div whileHover={{ y: -4 }} className="w-full">
          ...
          >
            <div className="p-8 relative z-10">
              <h2 className="text-base font-bold text-white mb-4">Contractual Specifications</h2>
              <div className="space-y-4 text-white/60 text-[13px] leading-relaxed font-light">
                <p>
                  By deploying NeoFace APIs, you agree to comply with user biometric collection rules:
                </p>
                <div className="p-4 rounded-xl bg-black/45 border border-white/[0.04]">
                  <h3 className="font-semibold text-white mb-1.5 text-[13px]">User Consent Framework</h3>
                  <p className="text-[12px] text-white/40">
                    Customers must obtain explicit consent from end-users before capturing biometric feeds, 
                    disclosing standard template conversion processes, and complying with biometric storage rules.
                  </p>
                </div>
              </div>
            </div>

...
export const superAdminNav: SidebarNavItem[] = [
  { id: "overview", label: "Overview", href: "/super", icon: LayoutDashboard, section: "PLATFORM" } as any,
  { id: "organizations", label: "Organizations", href: "/super/organizations", icon: Building2, section: "PLATFORM" } as any,
  { id: "projects", label: "Projects", href: "/super/projects", icon: FolderKanban, section: "PLATFORM" } as any,
  { id: "identities", label: "Identities", href: "/super/identities", icon: Users, section: "PLATFORM" } as any,
  { id: "authentication", label: "Authentication", href: "/super/authentication", icon: ZapIcon, section: "OPERATIONS" } as any,
  { id: "devices", label: "Devices", href: "/super/devices", icon: HardDrive, section: "OPERATIONS" } as any,
  { id: "security", label: "Security Center", href: "/super/security", icon: Shield, section: "OPERATIONS" } as any,
  { id: "ai-models", label: "AI Engine", href: "/super/ai-models", icon: Brain, section: "OPERATIONS" } as any,
  { id: "infrastructure", label: "Infrastructure", href: "/super/infrastructure", icon: Server, section: "OPERATIONS" } as any,
  { id: "reports", label: "Reports", href: "/super/reports", icon: BarChart3, section: "BUSINESS" } as any,
  { id: "billing", label: "Billing", href: "/super/billing", icon: CreditCard, section: "BUSINESS" } as any,
  { id: "integrations", label: "API & Integrations", href: "/super/integrations", icon: Layers, section: "BUSINESS" } as any,
  { id: "audit-logs", label: "Audit Logs", href: "/super/audit-logs", icon: FileText, section: "SYSTEM" } as any,
  { id: "announcements", label: "Notifications", href: "/super/announcements", icon: Megaphone, section: "SYSTEM" } as any,
  { id: "settings", label: "Settings", href: "/super/settings", icon: Settings, section: "SYSTEM" } as any,
];
